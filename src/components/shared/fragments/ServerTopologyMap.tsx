    ...
    <div className="w-full h-56 sm:h-64 md:h-72 rounded-2xl border border-indigo-100 bg-white/45 backdrop-blur-md p-4 sm:p-5 font-mono text-[10px] sm:text-xs text-slate-800 flex flex-col justify-between overflow-hidden relative shadow-[0_8px_30px_rgba(99,102,241,0.02),inset_0_1px_0_rgba(255,255,255,0.8)]">
      ...
      <div className="flex-grow relative flex items-center justify-center py-2">
        <svg className="w-full h-full overflow-visible" viewBox="0 0 240 100">
          ...
          <path d="M 30,50 Q 75,15 120,25" fill="none" stroke="rgba(99,102,241,0.2)" strokeWidth="1.5" />
          <path d="M 30,50 Q 75,85 120,75" fill="none" stroke="rgba(99,102,241,0.2)" strokeWidth="1.5" />
          {/* App Servers to DB */}
          <path d="M 120,25 Q 165,25 210,50" fill="none" stroke="rgba(6,182,212,0.2)" strokeWidth="1.5" />
          <path d="M 120,75 Q 165,75 210,50" fill="none" stroke="rgba(6,182,212,0.2)" strokeWidth="1.5" />

          {/* Request pulse travels */}
          <circle r="2.5" fill="#818cf8" className="shadow-lg">
            <animateMotion
              key={`p1-${pulseKey}`}
              dur="1.8s"
          ...
          <g transform="translate(30, 50)">
            <circle r="10" fill="rgba(99,102,241,0.1)" stroke="#6366f1" strokeWidth="1.5" />
            <circle r="4" fill="#6366f1" />
          </g>

          {/* Server A */}
          <g transform="translate(120, 25)">
            <circle r="12" fill="rgba(99,102,241,0.1)" stroke="#818cf8" strokeWidth="1.5" />
          ...
          <g transform="translate(120, 75)">
            <circle r="12" fill="rgba(6,182,212,0.1)" stroke="#22d3ee" strokeWidth="1.5" />
            <foreignObject x="-6" y="-6" width="12" height="12">
          ...
          <g transform="translate(210, 50)">
            <circle r="14" fill="rgba(16,185,129,0.1)" stroke="#10b981" strokeWidth="1.5" />
          ...
          <text x="30" y="70" textAnchor="middle" fill="rgba(99,102,241,0.5)" fontSize="8" fontWeight="bold">DNS</text>
          <text x="120" y="44" textAnchor="middle" fill="rgba(99,102,241,0.5)" fontSize="8" fontWeight="bold">APP_01</text>
          <text x="120" y="94" textAnchor="middle" fill="rgba(99,102,241,0.5)" fontSize="8" fontWeight="bold">APP_02</text>
          <text x="210" y="72" textAnchor="middle" fill="rgba(99,102,241,0.5)" fontSize="8" fontWeight="bold">DB_SQL</text>
        </svg>
      </div>

      {/* Database Metrics Indicator */}
      <div className="flex items-center justify-between border-t border-indigo-100 pt-2 mt-2 text-[10px] sm:text-xs">
        <div className="flex items-center gap-2">
          <span className="text-slate-400 font-bold">DB LOAD</span>
          <div className="w-24 h-2 bg-indigo-50 rounded-full overflow-hidden border border-indigo-100">
            <div
