        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
              <Link
                href={primaryHref}
                className="group inline-flex items-center gap-2 bg-indigo-500 text-white px-10 py-4 rounded-full text-base font-semibold hover:bg-indigo-600 transition-all duration-300 hover:gap-3 shadow-[0_4px_14px_rgba(99,102,241,0.35)]"
              >
                {primaryText}
