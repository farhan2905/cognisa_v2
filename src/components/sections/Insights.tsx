      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {articles.map((article, i) => (
            <motion.a key={article.title} href={article.link} custom={i} variants={cardVariants} initial="hidden" animate={isInView ? "visible" : "hidden"} className="group flex flex-col h-full relative overflow-hidden bg-gradient-to-br from-blue-600/5 via-indigo-500/[0.02] to-transparent backdrop-blur-2xl rounded-3xl p-6 border border-indigo-300/50 ring-1 ring-indigo-400/20 shadow-[0_10px_30px_rgba(59,130,246,0.15),inset_0_1px_0_rgba(255,255,255,0.25)] transition-all duration-500 hover:-translate-y-2 hover:from-blue-600/15 hover:via-indigo-500/5 hover:border-indigo-400/60 hover:ring-indigo-500/30 hover:shadow-[0_20px_60px_rgba(99,102,241,0.18),inset_0_1px_0_rgba(255,255,255,0.5)]">
